    ...
    <div class="container-fluid">
       <div class="row">
             ...
             <div class="col-lg-12  text-center">
                © Copyright 2023 V.R.1 USA  
             <!-- <a href="" class="mx-1">SocialV</a> -->
             |  All Right Reserved 
        </div>
        </div>
       </div>
                                ...
                                <div class="d-flex align-items-center">
                                    ...
                                    <div data-setting="radio">
                                        <input type="radio" value="default" class="btn-check" name="theme_color"
                                            id="default" data-colors='{"primary": "#7093e5", "secondary": "#f68685"}'>
...
function updateCarouselItems() {
    ...
    var itemsToShow = 1; // Default for mobile: show 1 item
    ...
    var allSlides = Array.from(document.querySelectorAll('.carousel-item .col-12'));

    // Clear the carousel
    carouselInner.innerHTML = '';

    // Create new carousel items with the correct number of slides
    for (let i = 0; i < allSlides.length; i += itemsToShow) {
        ...
        // Append the correct number of slides to this carousel item
        for (let j = i; j < i + itemsToShow && j < allSlides.length; j++) {
            var col = allSlides[j];
            col.style.display = 'block'; // Ensure the slide is visible
            row.appendChild(col.cloneNode(true)); // Clone the node to avoid moving original items
        }
